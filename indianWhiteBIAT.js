define(['pipAPI', 'https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.*/BIAT/qualtrics/qbiat5.js'], function(APIConstructor, iatExtension){
    ...
    categories : [  //As many categories you need.
      {
        ...
        title : {
          ...
          height : 4, //Height (because we need to know where to put the next item in the title)
          startStimulus : { 
            //Using word list instead of image for clarity
            media : {word : 'Ravi, Priya, Anil, Lakshmi'}, 
            css : {color:'#31b404','font-size':'1em'}, 
            height : 2
          }
        }, 
      ...
      },  
      {
        ...
        title : {
          ...
          height : 4,
          startStimulus : {
            media : {word : 'Charles, Emily, Mike, Nancy'},  
            css : {color:'#31b404','font-size':'1em'}, 
            height : 2
          }
        }, 
