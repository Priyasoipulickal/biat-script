...
define(['pipAPI','pipScorer'], function(APIConstructor,Scorer) {
    ...
    var category1 = 'Indians';
    var category2 = 'Caucasians';
    ...
    scorer.addSettings('message',{
        MessageDef: [
            { cut:'-0.65', message:'Your data suggest a strong implicit preference for Indians compared to Caucasians' },
            { cut:'-0.35', message:'Your data suggest a moderate implicit preference for Indians compared to Caucasians.' },
            { cut:'-0.15', message:'Your data suggest a slight implicit preference for Indians compared to Caucasians.' },
            { cut:'0.15', message:'Your data suggest little to no difference in implicit preference between Indians and Caucasians.' },
            { cut:'0.35', message:'Your data suggest a slight implicit preference for Caucasians compared to Indians' },
            { cut:'0.65', message:'Your data suggest a moderate implicit preference for Caucasians compared to Indians' },
            { cut:'3', message:'Your data suggest a strong implicit preference for Caucasians compared to Indians' }
        ]
    });
